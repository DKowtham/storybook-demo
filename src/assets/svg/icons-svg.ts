...
// Here we can place svg icons to import on our components

export const svg_icon_info: SVGTemplateResult = svg`<svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M13.1 1C19.8 1 25.2 6.4 25.2 13.1C25.2 19.8 19.8 25.2 13.1 25.2C6.4 25.1 1 19.7 1 13.1C1 6.4 6.4 1 13.1 1Z" stroke="currentColor" stroke-width="1.9578"/>
